...
const RightContactUs = () => {
  ...
  return (
    <section
      className={
        style.contactus_section_right +
        " light-colored-background dark-colored-text"
      }
    >
      <form className={style.contactus_right_wrapper}>
        <h3 className="font_h3_headline">Fill in your details</h3>
        ...
        <div className={style.input_container}>
          {formList.map((name) => {
            return (
              <div key={name}>
                <label
                  className={`font_small_bold ${
                    name === "Message"
                      ? style.message_label + " primary-colored-text"
                      : ""
                  }`}
                  htmlFor={name}
                >
